...
class CreateAccountOtpVerificationScreen extends StatelessWidget {
  const CreateAccountOtpVerificationScreen({super.key});
              ...
              child: Form(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 20),
                      child: Text("Enter the OTP sent to  ${auth.otpSubtitle}- ${auth.maskedValue} ",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold),),
                    ),
