...
import 'package:seva_saathi/controller/view/create_account_otp_verification_screen.dart';
import 'package:seva_saathi/controller/view/forgot_email_screen.dart';

import 'forgot_phone_screen.dart';

class CreateOtpChoiceScreen extends StatelessWidget {
  const CreateOtpChoiceScreen({super.key});
                    ...
                    onTap: () {
                      ...
                      if (auth.isSms) {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const CreateAccountOtpVerificationScreen(),
                          ),
                        );
                      } else {
                        Navigator.pushReplacement(
